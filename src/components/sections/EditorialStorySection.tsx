...
export default function EditorialStorySection({ onOpenCheckout }: EditorialStoryProps) {
  return (
    <section id="editorial-story" className="py-24 bg-[#111115] border-y border-white/10 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <motion.div
            ...
            className="lg:col-span-7 relative rounded-3xl overflow-hidden border border-white/10 shadow-2xl min-h-[480px] lg:min-h-[580px] group"
          >
            <Image
          ...
          <div className="lg:col-span-5 flex flex-col justify-between gap-8">
            ...
            <motion.div
              ...
              className="relative h-60 sm:h-64 w-full rounded-3xl overflow-hidden border border-white/10 shadow-xl group"
            >
              <Image
              ...
              <div className="absolute bottom-4 left-5 right-5 flex items-center justify-between">
                <div>
                  <span className="text-[10px] font-mono uppercase text-[#E50914] font-bold block">
                    Pillar 02
                  </span>
            ...
            <motion.div
              ...
              className="p-8 rounded-3xl bg-[#09090B] border border-white/10 flex flex-col justify-between flex-1 space-y-6"
            >
              <div className="space-y-3">
                <div className="inline-flex items-center gap-2 text-[10px] font-mono font-bold uppercase tracking-widest text-[#E50914]">
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full sm:w-auto px-7 py-3.5 rounded-full bg-[#E50914] hover:bg-[#FF2424] text-white font-heading font-black text-xs uppercase tracking-wider shadow-lg shadow-[#E50914]/30 hover:shadow-[#E50914]/50 transition-all flex items-center justify-center gap-2"
                >
