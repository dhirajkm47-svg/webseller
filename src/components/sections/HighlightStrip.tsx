...
export default function HighlightStrip({ onOpenCheckout }: HighlightStripProps) {
  return (
    <section className="py-20 bg-[#091124] border-y border-white/10 relative overflow-hidden">
      {/* Ambient background accent */}
      <div className="absolute -left-20 top-1/2 -translate-y-1/2 w-72 h-72 bg-[#0066FF]/15 blur-3xl pointer-events-none rounded-full" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          {/* Left Column: Bold Headline & Manifesto */}
          <div className="lg:col-span-5 space-y-6">
            <div className="inline-flex items-center gap-2 text-xs font-black uppercase tracking-[0.25em] text-[#00C6FF] font-heading">
            ...
            <h2 className="text-4xl sm:text-5xl font-black text-white uppercase font-heading tracking-tight leading-[1.05]">
              BUILT FOR<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0066FF] to-[#00C6FF]">A STRONGER</span><br />
              YOU
            </h2>
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
            {/* Photo Panel 1 */}
            <div className="relative h-64 sm:h-72 rounded-2xl overflow-hidden border border-[#00C6FF]/25 group shadow-xl bg-[#0D1730]">
              <Image
              ...
              <div className="absolute bottom-5 left-5 right-5">
                <span className="text-[10px] uppercase font-mono tracking-widest text-[#00C6FF] font-bold block mb-1">
                  Zone 01
                </span>
