...
export default function HighlightStrip({ onOpenCheckout }: HighlightStripProps) {
  return (
    <section className="py-20 bg-[#111115] border-y border-white/10 relative overflow-hidden">
      ...
      <div className="absolute -left-20 top-1/2 -translate-y-1/2 w-72 h-72 bg-[#E50914]/10 blur-3xl pointer-events-none rounded-full" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          {/* Left Column: Bold Headline & Manifesto */}
          <div className="lg:col-span-5 space-y-6">
            <div className="inline-flex items-center gap-2 text-xs font-black uppercase tracking-[0.25em] text-[#E50914] font-heading">
            ...
            <h2 className="text-4xl sm:text-5xl font-black text-white uppercase font-heading tracking-tight leading-[1.05]">
              BUILT FOR<br />
              <span className="text-[#E50914]">A STRONGER</span><br />
              YOU
            </h2>
            ...
            <div className="pt-2">
              <button
                ...
                className="px-7 py-3.5 rounded-full bg-[#E50914] hover:bg-[#FF2424] text-white font-heading font-black text-xs uppercase tracking-wider shadow-lg shadow-[#E50914]/30 hover:shadow-[#E50914]/50 transition-all flex items-center gap-2"
              >
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
            {/* Photo Panel 1 */}
            <div className="relative h-64 sm:h-72 rounded-2xl overflow-hidden border border-white/10 group shadow-xl">
              <Image
              ...
              <div className="absolute bottom-5 left-5 right-5">
                <span className="text-[10px] uppercase font-mono tracking-widest text-[#E50914] font-bold block mb-1">
                  Zone 01
                </span>
