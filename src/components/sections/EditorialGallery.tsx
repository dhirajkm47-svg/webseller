...
export default function EditorialGallery() {
  return (
    <section id="gallery" className="py-24 bg-[#050B18] border-t border-white/10 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Header */}
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div className="space-y-3">
            <div className="inline-flex items-center gap-2 text-xs font-heading font-black uppercase tracking-[0.25em] text-[#00C6FF]">
            ...
            <h2 className="text-3xl sm:text-5xl lg:text-6xl font-black text-white uppercase font-heading tracking-tight leading-[1.02]">
              FITNESS IN <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0066FF] to-[#00C6FF]">MOTION</span>
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-6">
          ...
          <motion.div
            ...
            className="md:col-span-7 relative h-[360px] sm:h-[480px] lg:h-[540px] rounded-3xl overflow-hidden border border-[#00C6FF]/25 shadow-2xl group bg-[#0D1730]"
          >
            <Image
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#050B18]/90 via-[#050B18]/20 to-transparent" />
          ...
          <div className="md:col-span-5 flex flex-col gap-4 sm:gap-6">
            ...
            <motion.div
              ...
              className="relative h-[220px] sm:h-[255px] rounded-3xl overflow-hidden border border-white/10 shadow-xl group bg-[#0D1730]"
            >
              <Image
              ...
              <div className="absolute bottom-4 left-5 right-5">
                <span className="text-[10px] font-mono text-[#00C6FF] uppercase font-bold block">
                  Cardio Space
                </span>
          ...
          <motion.div
            ...
            className="md:col-span-6 relative h-[240px] sm:h-[280px] rounded-3xl overflow-hidden border border-white/10 shadow-xl group bg-[#0D1730]"
          >
            <Image
