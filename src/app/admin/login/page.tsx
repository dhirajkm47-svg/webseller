...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-dark-bg text-zinc-100 flex items-center justify-center p-4 relative selection:bg-brand-600 selection:text-white">
      {/* Background Accent */}
      ...
      <div className="w-full max-w-md bg-dark-card border border-white/15 rounded-3xl p-8 shadow-2xl relative z-10">
        <div className="mb-6">
          <Link
            href="/"
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 rounded-xl bg-dark-bg border border-white/10 text-white placeholder-zinc-500 text-sm focus:outline-none focus:border-brand-500 transition-colors"
              />
            </div>
          </div>
          ...
          <div className="p-3 rounded-xl bg-white/5 border border-white/10 text-[11px] text-zinc-400 space-y-1 font-mono">
